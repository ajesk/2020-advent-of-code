...
func get2020(accountNumbers []int) int {
	for i, s := range accountNumbers {
		for h := i + 1; h < len(accountNumbers); h++ {
			if s+accountNumbers[h] == 2020 {
				return s * accountNumbers[h]
			}
		}
	}
	return 0
...
func main() {
	accountNumbers := []int{1837, 1585, 1894, 1715, 1947, 1603, 1746, 1911, 1939, 1791, 1800, 1479,
		1138,
		1810,
		1931,
		1833,
